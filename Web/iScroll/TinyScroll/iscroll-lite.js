...
// INSERT POINT: _init
	...
	_start: function (e) {
        ...
        this.initiated	= utils.eventType[e.type]; // touch || mouse || pointer
		this.moved		= false;
		this.distX		= 0;
		this.distY		= 0;
		this.directionX = 0;
		...
		if ( this.options.useTransition && this.isInTransition ) {
			...
			this._translate(Math.round(pos.x), Math.round(pos.y)); // translate肯定是 修改了 this.x, this.y
			this._execEvent('scrollEnd');
